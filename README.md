...
Here, the reference cross track error (![](https://latex.codecogs.com/gif.latex?cte_{ref})), orientation error (![](https://latex.codecogs.com/gif.latex?e\psi_{ref})) and speed (![](https://latex.codecogs.com/gif.latex?v_{ref})) are set as below:
